    ...
    <section id="catalog" className="py-20 bg-iberia-dark">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative bg-[#f0b8a8] rounded-3xl overflow-hidden p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 min-h-[420px] md:min-h-[460px] pb-[360px] md:pb-12">
          ...
          <div className="z-10 relative w-full md:w-[420px] md:flex-shrink-0 md:self-start md:mt-2">
            <h2 className="text-xl md:text-3xl font-bold text-iberia-dark mb-3">
            ...
            <div className="flex flex-wrap gap-3 mb-4">
              {[
                ...
                <div key={line1} className="flex items-center gap-2 w-[calc(50%-6px)] md:w-[calc(50%-6px)]">
          ...
          {/* Каталог — задний план, мобильный, прямо на розовой карточке */}
          <img
            ...
            style={{ width: '360px', left: 'calc(60% - 60px)', bottom: '5px', transform: 'rotate(3deg)', transformOrigin: 'bottom left' }}
          />
