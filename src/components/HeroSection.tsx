...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[100svh] sm:min-h-screen flex flex-col justify-end sm:justify-center overflow-hidden pb-4 sm:pb-0">
      <style>{`
        @keyframes wave-ltr {
      ...
      <div className="absolute top-20 left-6 right-6 z-10 sm:hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-0 sm:pt-24 pb-0 sm:pb-16 w-full">
