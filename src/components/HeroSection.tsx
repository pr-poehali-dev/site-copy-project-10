      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-0 sm:pt-24 pb-0 sm:pb-16 w-full">
        ...
        <div className="relative bg-iberia-dark/80 backdrop-blur-sm border border-white/10 rounded-2xl p-4 sm:p-6 w-full sm:w-fit mb-0 sm:mb-10 overflow-hidden">
          ...
          <button
            ref={btnRef}
            onClick={openQuiz}
            className="wave-btn flex items-center gap-2 bg-iberia-orange text-white font-semibold px-6 py-3 rounded-full hover:bg-[#e26e60] transition-colors w-[60%] sm:w-auto justify-center whitespace-nowrap"
          >
