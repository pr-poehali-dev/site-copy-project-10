  ...
  return (
    <section className="relative min-h-[170vh] sm:min-h-screen flex flex-col justify-end sm:justify-center overflow-hidden pb-16 sm:pb-0">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 pt-0 sm:pt-24 pb-16 w-full">
        ...
        <div className="absolute top-20 left-3 right-3 sm:static sm:max-w-4xl sm:mb-10 bg-iberia-dark/80 backdrop-blur-sm border border-white/10 rounded-2xl px-5 py-4 sm:bg-transparent sm:backdrop-blur-none sm:border-0 sm:rounded-none sm:p-0">
        ...
        <div className="relative bg-iberia-dark/80 backdrop-blur-sm border border-white/10 rounded-2xl p-4 sm:p-6 w-full sm:w-fit mb-10 overflow-hidden">
          ...
          <button
            ref={btnRef}
            onClick={openQuiz}
            className="wave-btn flex items-center gap-2 bg-iberia-orange text-white font-semibold px-6 py-3 rounded-full hover:bg-[#e26e60] transition-colors w-[60%] sm:w-auto justify-center"
          >
