  ...
  return (
    <section className="relative min-h-[170vh] sm:min-h-screen flex flex-col justify-end sm:justify-center overflow-hidden pb-16 sm:pb-0">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 pt-0 sm:pt-24 pb-16 w-full">
        <div className="max-w-4xl mb-6 sm:mb-10 bg-iberia-dark/80 backdrop-blur-sm border border-white/10 rounded-2xl px-5 py-4 sm:bg-transparent sm:backdrop-blur-none sm:border-0 sm:rounded-none sm:p-0 -translate-y-[200%] sm:translate-y-0">
